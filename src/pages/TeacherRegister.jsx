...
const TeacherRegister = () => {
	...
	const handleSubmit = (e) => {
		...
		setLoader(true)
		e.preventDefault();
		axios('http://localhost:4000/auth/teacherregister', {
			method: "POST",
			data: {
				name: name,
				email: email,
		...
		<>
			...
			<div className='md:flex'>
				<div className='w-1/2 flex flex-col justify-center items-center bg-orange-300 '>
					...
					<Lottie className='w-[80%] h-[80%] md:block hidden' animationData={teacherAnimation} />
				</div>

				<div className="flex items-center justify-center h-screen md:shadow-xl px-2 md:w-1/2  md:bg-white">
